...
class Imager():
    ...
    ## The two concatenate operations will handle img of different sizes
...
def ptest1(fid1='img/kdfinger.jpeg', fid2="img/einstein.jpeg",steps=5,newsize=250):
...
def ptest2(fid1='img/einstein.jpeg',outfid='img/tunnel.jpeg',levels=3,newsize=250,scale=0.8):
    im1 = Imager(fid1);
...
def ptest3(fid1='img/kdfinger.jpeg', fid2="img/einstein.jpeg",newsize=250,levels=4,scale=0.75):
    im1 = Imager(fid1); im2 = Imager(fid2)
    im1 = im1.resize(newsize,newsize); im2 = im2.resize(newsize,newsize)
